...
coin_detector.file_reader.FileReader.get_samples(coin_type=coin_detector.Coin.GR_20)
...
Material = Enum(('Aluminium', 'Copper'))

# locate sample image files
sample_images_copper = [
    "sample_images/1.jpg",
    "sample_images/2.jpg",
    "sample_images/5.jpg",
]

sample_images_aluminium = [
    "sample_images/10.jpg",
    "sample_images/20.jpg",
    "sample_images/50.jpg",
    "sample_images/100.jpg",
]
...
for i in sample_images_aluminium:
    X.append(calcHistFromFile(i))
    y.append(Material.Aluminium)
